...
if __name__ == '__main__':
    ...
    dsets = ['mnist', 'fashion-mnist', 'cifar10','cifar100']
    batch_sizes = [1, 4]
    for d in dsets:
        split = DataSplit(d)
        for b in batch_sizes:
            for loader in split.get_train_loader(1), split.get_valid_loader(2), split.get_test_loader(3),split.get_test_loader(4):
